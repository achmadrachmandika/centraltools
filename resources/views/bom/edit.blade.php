                            ...
                            <div class="col-md-12" style="min-width:80vw">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="post"
                                            action="{{ route('bom.update', ['bom' => $bom->nomor_bom]) }}" id="myForm">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                <div class="col">
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{ $bom[" kode_material_$i"] }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{ $bom[" nama_material_$i"] }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{ $bom[" spek_material_$i"] }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-1">
                                                    <div class="form-group">
                                                        <input type="text" name="jumlah_material_{{ $i }}"
                                                            ...
                                                            value="{{ $bom[" jumlah_material_$i"] }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <input type="text" name="satuan_material_{{ $i }}"
                                                            ...
                                                            value="{{ $bom[" satuan_material_$i"] }}" readonly>
                                                    </div>
                                                </div>
                                    </div>
                                    @endif
