                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form method="post"
                                        action="{{ route('kode_material.update', ['kode_material' => $kodeMaterial->kode_material]) }}" id="myForm">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode_material" class="form-control"
                                                id="kode_material" value="{{ $kodeMaterial->kode_material }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="spek">Spesifikasi</label>
                                            <input type="text" name="spek" class="form-control" id="spek"
                                                value="{{ $kodeMaterial->spek }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="keterangan">Keterangan</label>
                                            <input type="text" name="keterangan" class="form-control" id="keterangan"
                                                value="{{ $kodeMaterial->keterangan }}">
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2">Submit</button>
                                        <a href="{{ route('kode_material.index') }}"
