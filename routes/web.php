...
Route::middleware('auth')->group(function () {
    Route::middleware('role:admin|staff')->group(function () {
        ...
        Route::prefix('loans')->name('loans.')->group(function () {
            Route::get('/', [ProjectMaterialLoanController::class, 'index'])->name('index');
            Route::get('/data', [ProjectMaterialLoanController::class, 'getData'])->name('data');
            Route::get('/create', [ProjectMaterialLoanController::class, 'create'])->name('create');
            Route::post('/store', [ProjectMaterialLoanController::class, 'store'])->name('store');
            Route::get('/{id}', [ProjectMaterialLoanController::class, 'show'])->name('show');

            // Routes untuk pengembalian
            Route::get('/{id}/return', [ProjectMaterialLoanController::class, 'returnLoan'])->name('return'); // Pengembalian semua
            Route::get('/{id}/return-form', [ProjectMaterialLoanController::class, 'showReturnForm'])->name('return-form'); // Form pengembalian parsial
            Route::post('/{id}/process-return', [ProjectMaterialLoanController::class, 'processReturn'])->name('process-return'); // Proses pengembalian parsial
        });
